...
contract VestingTransferable is Vesting {
    ...
    constructor(address newClaimant, address newOwner, address bondTokenAddress, uint startTime, uint totalBalance) Vesting(newOwner, bondTokenAddress, startTime, totalBalance) public {
